...
class MpiadvanceStreamTriggering(CMakePackage, CudaPackage, ROCmPackage):
    """Locality-aware optimizations for standard MPI collectives as well as neighborhood collectives."""

    homepage = https://github.com/mpi-advance/stream-triggering
    ...
    version("0.1", sha256="67d0559aea2dd30955f82fdaa7ce3665001dc6d8b0761afd2be51215f6809f79")
